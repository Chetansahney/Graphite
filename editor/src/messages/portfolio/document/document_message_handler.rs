...
impl DocumentMessageHandler {
	...
	fn handle_nudge_selected_layers(
		...
		// Clamp both the current and new sizes to a minimum of 1 unit per axis.
		// This prevents the shape from reaching zero size (which would lock it permanently) and avoids division by zero.
